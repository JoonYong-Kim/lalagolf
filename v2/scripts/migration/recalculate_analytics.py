...
from app.services.migration import get_run, owner_for_cli, recalculate_imported_rounds


def main() -> None:
    parser = argparse.ArgumentParser(description="Recalculate analytics for imported migration rounds.")
    ...
    with SessionLocal() as db:
        ...
        result = recalculate_imported_rounds(db, owner=owner, run=run)
        db.commit()
